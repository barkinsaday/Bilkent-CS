...
set_property PACKAGE_PIN V3 [get_ports {LB[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LB[2]}]
set_property PACKAGE_PIN W3 [get_ports {LB[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LB[1]}]
set_property PACKAGE_PIN U3 [get_ports {LB[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LB[0]}]
#set_property PACKAGE_PIN P3 [get_ports {led[12]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led[12]}]
set_property PACKAGE_PIN N3 [get_ports {LA[2]}]					
...
set_property PACKAGE_PIN L1 [get_ports {LA[0]}]					
