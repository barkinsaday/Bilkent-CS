      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'searchMembersPage',
              path: 'searchMembersPage',
              builder: (context, params) => SearchMembersPageWidget(),
            ),
            FFRoute(
              name: 'chat',
              path: 'chat',
            ...
            FFRoute(
              name: 'planned_lesson',
              path: 'plannedLesson',
              builder: (context, params) => PlannedLessonWidget(),
            ),
            FFRoute(
              name: 'homeworks',
              path: 'homeworks',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'homeworks')
                  : HomeworksWidget(),
            ),
            FFRoute(
              name: 'settings',
            ...
            FFRoute(
              ...
              path: 'scheduleLesson',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'schedule_lesson')
            ...
            FFRoute(
              ...
              path: 'adminReport',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'adminReport')
                  : AdminReportWidget(),
            ),
            FFRoute(
              name: 'assignHomework',
              path: 'assignHomework',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'assignHomework')
                  : AssignHomeworkWidget(),
            )
