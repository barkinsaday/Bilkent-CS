                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.passwordConfirmFocusNode1,
                              autofocus: true,
                              autofillHints: [AutofillHints.password],
                              obscureText: !_model.passwordConfirmVisibility1,
                              decoration: InputDecoration(
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.passwordConfirmFocusNode2,
                                    autofocus: true,
                                    autofillHints: [AutofillHints.password],
                                    obscureText:
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        '6pbnbzqo' /* Phone Number */,
                                      ),
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '53vi47xi' /* Enter  your phone number... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      enabledBorder: OutlineInputBorder(
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.passwordConfirmController3,
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        '6pfqq1lm' /* Enter Your Native Language */,
                                      ),
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'biimgcsh' /* Enter your native language... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                      enabledBorder: OutlineInputBorder(
